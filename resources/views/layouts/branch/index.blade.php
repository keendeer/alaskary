                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group text-left" style="margin-bottom: auto;">
                                                        ...
                                                        @can('update', $branch)
                                                            <a href="{{route('branch.edit', $branch->id)}}" class="btn btn-icon btn-info mr-1 btn11"><i class="la la-pencil"></i></a>
                                                        @endcan    
                                                        @can('delete', $branch)
                                                            <button type="button" data-id="{{$branch->id}}" class="btn btn-icon btn-danger mr-1 btn11"><i class="la la-trash"></i></button>
                                                        @endcan
                                                    </div>
                                                </td>
                                            </tr>
